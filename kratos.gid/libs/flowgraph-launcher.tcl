...
proc Flowgraph::LaunchFlowgraph {} {
    ...
    switch $status {
        ...
        0 {
            ...
            W "-np- Flowgraph::KillAllContainers"
        }
        default {
...
proc Flowgraph::KillAllContainers {} {
    variable docker_image
    W "Stopping all running instances of Flowgraph..."
    Kratos::KillAllContainersForImage $docker_image
}
