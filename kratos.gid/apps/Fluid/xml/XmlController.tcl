namespace eval ::Kratos::Fluid::xml {
    # Namespace variables declaration

    proc Init { dir } {
        ::Model::InitVariables dir $dir
    ...
    proc CustomTree { args } {
        set root [customlib::GetBaseRoot]

        set results_un [GetUniqueName "results"]
    ...
    # Usage 
    # CreateNewInlet Inlet {new false name Total} true "6*y*(1-y)"
    proc CreateNewInlet { base_group_name {interval_data {new true name inlet1 ini 0 end "End"}} {uses_formula false} {value 10.0} {direction automatic_inwards_normal} {fluid_conditions_UN FLBC} {inlet_condition_name_base AutomaticInlet} } {
        # Fluid Inlet
    ...
    proc ClearInlets { delete_groups {fluid_conditions_UN FLBC} {inlet_condition_name_base AutomaticInlet} } {
    ...
    proc ProcHideIfElement { domNode list_elements } {
        set element [lindex [write::GetUsedElements] 0]
