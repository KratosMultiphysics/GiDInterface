...
proc Fluid::examples::DrawMokChannelFlexibleWallGeometry {args} {
    Kratos::ResetModel
...
proc Fluid::examples::AssignMokChannelFlexibleWallMeshSizes {args} {
...
proc Fluid::examples::TreeAssignationMokChannelFlexibleWall {args} {
