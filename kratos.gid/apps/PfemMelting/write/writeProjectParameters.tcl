...
proc PfemMelting::write::GetTimeSettings { } {
    return [Buoyancy::write::GetTimeSettings]
}

proc PfemMelting::write::GetGravity { } {
    return [Buoyancy::write::GetGravity]
}

proc PfemMelting::write::writeParametersEvent { } {
    write::SetParallelismConfiguration
    write::WriteJSON [PfemMelting::write::getParametersDict]
}
