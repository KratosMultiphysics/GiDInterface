proc Buoyancy::write::WriteMDPAParts { } {
    ...
    # Materials
    PfemMelting::write::writeMaterialsParts

    # Nodal coordinates (only for Buoyancy Parts <inefficient> )
    write::writeNodalCoordinatesOnParts
    write::writeNodalCoordinatesOnGroups [GetDEMGroupsCustomSubmodelpart]
    write::writeNodalCoordinatesOnGroups [Buoyancy::write::GetDEMGroupsInitialC]
    write::writeNodalCoordinatesOnGroups [Buoyancy::write::GetDEMGroupsBoundayC]
    write::writeNodalCoordinatesOnGroups [Buoyancy::write::GetNodesForGraphs]

    # Element connectivities
    write::writeElementConnectivities

    # Begin NodalData RADIUS
    PfemMelting::write::writeSphereRadius

    # Begin NodalData COHESIVE_GROUP
    PfemMelting::write::writeCohesiveGroups

    # Begin NodalData SKIN_SPHERE
    PfemMelting::write::writeSkinSphereNodes

    # SubmodelParts
    write::writePartSubModelPart
	Buoyancy::write::writeDEMConditionMeshes

    # CustomSubmodelParts
    PfemMelting::write::WriteCustomDEMSmp
}

## TODO: proc under revision. This works but the proc is different from the Buoyancy::write version.
proc PfemMelting::write::WriteCustomDEMSmp { } {
    set xp1 "[spdAux::getRoute [GetAttribute conditions_un]]/condition\[@n = 'Buoyancy-CustomSmp'\]/group"
...
proc PfemMelting::write::GetDEMGroupsCustomSubmodelpart { } {
    set groups [list ]
    set xp2 "[spdAux::getRoute [GetAttribute conditions_un]]/condition\[@n = 'Buoyancy-CustomSmp'\]/group"
...
proc PfemMelting::write::writeSphereRadius { } {
...
proc PfemMelting::write::writeCohesiveGroups { } {
    set root [customlib::GetBaseRoot]
    if {$::Model::SpatialDimension eq "3D"} {
        set xp1 "[spdAux::getRoute [GetAttribute conditions_un]]/condition\[@n = 'Buoyancy-Cohesive'\]/group"
    } else {
        set xp1 "[spdAux::getRoute [GetAttribute conditions_un]]/condition\[@n = 'Buoyancy-Cohesive2D'\]/group"
    }
...
proc PfemMelting::write::writeSkinSphereNodes { } {
    # Write Skin Sphere
    set number 1
...
proc PfemMelting::write::writeMaterialsParts { } {
