namespace eval ::PfemThermic::examples::ThermicSloshing {
    namespace path ::PfemThermic::examples
    Kratos::AddNamespace [namespace current]

}
proc ::PfemThermic::examples::ThermicSloshing::Init {args} {
...
# Draw Geometry
proc PfemThermic::examples::ThermicSloshing::DrawGeometry {args} {
    ## Layer ##
...
# Group assign
proc PfemThermic::examples::ThermicSloshing::AssignGroups {args} {
...
# Tree assign
proc PfemThermic::examples::ThermicSloshing::TreeAssignation {args} {
    # Physics
	...
	set props [list value 293.15 Interval Initial constrained 1]
