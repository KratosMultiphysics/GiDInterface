...
proc :: ConvectionDiffusion::examples::CylinderInFlow {args} {
...
# Draw Geometry
proc  ConvectionDiffusion::examples::DrawCylinderInFlowGeometry3D {args} {
...
proc  ConvectionDiffusion::examples::DrawCylinderInFlowGeometry2D {args} {
    Kratos::ResetModel
...
# Group assign
proc  ConvectionDiffusion::examples::AssignGroupsCylinderInFlow2D {args} {
    # Create the groups
...
proc  ConvectionDiffusion::examples::AssignGroupsCylinderInFlow3D {args} {
    # Create the groups
    GiD_Groups create Fluid
    GiD_Groups edit color Fluid "#26d1a8ff"
...
# Mesh sizes
proc  ConvectionDiffusion::examples::AssignCylinderInFlowMeshSizes3D {args} {
...
proc  ConvectionDiffusion::examples::AssignCylinderInFlowMeshSizes2D {args} {
    set cylinder_mesh_size 0.005
    set fluid_mesh_size 0.05
    GiD_Process Mescape Utilities Variables SizeTransitionsFactor 0.4 escape escape
...
# Tree assign
proc  ConvectionDiffusion::examples::TreeAssignationCylinderInFlow3D {args} {
    TreeAssignationCylinderInFlow2D
    AddCuts
}
proc  ConvectionDiffusion::examples::TreeAssignationCylinderInFlow2D {args} {
