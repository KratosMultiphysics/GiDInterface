...
proc ::Chimera::write::getParametersDict { } {
    ...
    set solverSettingsDict [dict merge $solverSettingsDict [write::getSolversParametersDict Chimera] ]
...
proc Chimera::write::getAuxiliarProcessList {} {
...
proc Chimera::write::getDistanceModificationDict { } {
...
proc Chimera::write::getEmbeddedDragProcessDict {} {
...
proc Chimera::write::getMeshAdaptivityProcessDict {} {
    set pdict [dict create]
