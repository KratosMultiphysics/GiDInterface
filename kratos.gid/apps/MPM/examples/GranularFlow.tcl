...
proc ::MPM::examples::GranularFlow::TreeAssignation2D {args} {
    ...
    set props [list Element UpdatedLagrangian$nd ConstitutiveLaw $constitutive_law_name Material GranularMaterial DENSITY 2650 YOUNG_MODULUS 840000 POISSON_RATIO 0.3 THICKNESS 0.1 PARTICLES_PER_ELEMENT 3]
