...
proc DEM::write::GetInletConditionXpath { } {
    ...
    set xp1 "[spdAux::getRoute [GetAttribute conditions_un]]/condition\[@n = '$condition_name'\]/group"
	return $xp1
}
...
proc DEM::write::GetInletGroups { } {
    ...
    foreach group [[customlib::GetBaseRoot] selectNodes [DEM::write::GetInletConditionXpath]] {
		set groupid [$group @n]
    ...
    foreach groupid [dict keys $inletProperties ] {
        if {[dict get $inletProperties $groupid InletElementType] in [list "Cluster2D" "Cluster3D"]} {
            ...
            if { $inlet_element_type == "FromFile" } {
                set cluster_full_path [dict get $inletProperties $groupid ClusterFilename]
